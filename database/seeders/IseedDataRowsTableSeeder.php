    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                'id' => 77,
                'data_type_id' => 12,
                'field' => 'tipo_avaliador',
                'type' => 'select_dropdown',
                'display_name' => 'Tipo Avaliador',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"default":"INTERNO","options":{"INTERNO":"Interno","EXTERNO":"Externo"}}',
                'order' => 3,
            ),
            77 => 
            array (
            ...
            array (
                'id' => 80,
                'data_type_id' => 12,
                'field' => 'avaliadore_belongsto_user_relationship',
                'type' => 'relationship',
                ...
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\User","table":"users","type":"belongsTo","column":"user_id","key":"id","label":"name","pivot_table":"alunos","pivot":"0","taggable":"0"}',
                'order' => 6,
            ),
            80 => 
            array (
            ...
            array (
                'id' => 83,
                'data_type_id' => 14,
                'field' => 'data_inicio_avaliacao',
                'type' => 'date',
                'display_name' => 'Data Inicio Avaliacao',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
            ...
            array (
                'id' => 84,
                'data_type_id' => 14,
                'field' => 'data_fim_avaliacao',
                'type' => 'date',
                'display_name' => 'Data Fim Avaliacao',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
            ...
            array (
                'id' => 88,
                'data_type_id' => 12,
                'field' => 'avaliadore_belongstomany_area_relationship',
                'type' => 'relationship',
                'display_name' => 'Áreas de interesse',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\Area","table":"areas","type":"belongsToMany","column":"id","key":"id","label":"nome","pivot_table":"avaliadores_areas","pivot":"1","taggable":"0"}',
                'order' => 7,
            ),
        ));
